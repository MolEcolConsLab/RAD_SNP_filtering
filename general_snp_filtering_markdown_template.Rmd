...
The goal with HDPlot is to capture the dense cloud of points that looks like a finger jutting out from the left side of the graph.
...
## Chunk 11: Export data using radiator
