...
file_directory <- ""
file_prefix <- "" #The part before ".vcf"
popmap_file <- "" #The part before ".txt"
...
## END MAIN SCRIPT
The chunk 13 can be used if wanting to filter for LD in a reference-based workflow, but is not relevant if using a de novo workflow or microhaplotypes.
